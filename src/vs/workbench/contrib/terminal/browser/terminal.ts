 ...
 * {@link IDetachedTerminalInstance} (a terminal used elsewhere in BillAI UI).
 */
 ...
 * to represent terminals that appear in other parts of the BillAI UI outside
...
export interface IXtermTerminal extends IDisposable {
	...
	*/
	...
	/**
	 * Selects the content between the two markers by their BillAI OSC `SetMarker`
