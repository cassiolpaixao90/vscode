...
impl CodeVersionManager {
	...
	/// Tries to find the binary entrypoint for BillAI installed in the path.
...
fn detect_installed_program(log: &log::Logger) -> io::Result<Vec<PathBuf>> {
	...
	//        Location: /Users/connor/Downloads/BillAI - Exploration 2.app
	//
...
mod tests {
	...
	fn test_detect_installed_program() {
		// developers can run this test and debug output manually; BillAI will not
