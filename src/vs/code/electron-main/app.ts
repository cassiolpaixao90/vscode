...
/**
 * The main BillAI application. There will only ever be one instance,
...
export class CodeApplication extends Disposable {
	...
	async startup(): Promise<void> {
		this.logService.debug('Starting BillAI');
		...
		// "com.microsoft.", which breaks native tabs for BillAI when using this
