...
/**
 * Allows webviews to monitor when an element in the BillAI editor is being dragged/dropped.
 *
 * This is required since webview end up eating the drag event. BillAI needs to see this
