---
description: Architecture documentation for BillAI interactive window component. Use when working in folder 
---

# Interactive Window

The interactive window component enables extensions to offer REPL like experience to its users. BillAI provides the user interface and extensions provide the execution environment, code completions, execution results rendering and so on.
