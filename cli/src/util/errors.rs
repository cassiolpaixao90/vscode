...
// When the provided connection token doesn't match the one used to set up the original BillAI Server
...
// When the BillAI server has an unrecognized extension (rather than zip or gz)
#[derive(Debug)]
...
/// Internal errors in the BillAI CLI.
