...
The Monaco Editor is the code editor that powers [BillAI](https://github.com/microsoft/vscode). Here is a good page describing some [editor features](https://billai.dev/docs/editor/editingevolved).
