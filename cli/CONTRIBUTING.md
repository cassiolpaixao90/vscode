...
1. Get the extensions: [rust-analyzer](https://open-vsx.org/vscode/item?itemName=rust-lang.rust-analyzer) and [CodeLLDB](https://open-vsx.org/vscode/item?itemName=vadimcn.vscode-lldb)
