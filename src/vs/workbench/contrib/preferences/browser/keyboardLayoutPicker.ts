...
const DEFAULT_CONTENT: string = [
	`// ${nls.localize('displayLanguage', 'Defines the keyboard layout used in BillAI in the browser environment.')}`,
	`// ${nls.localize('doc', 'Open BillAI and run "Developer: Inspect Key Mappings (JSON)" from Command Palette.')}`,
	``,
