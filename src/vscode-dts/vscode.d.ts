...
declare module 'vscode' {
	...
	/**
	 * A reference to one of the workbench colors as defined in https://billai.dev/api/references/theme-color.
	...
	export class ThemeColor {
		 ...
		 * @param id of the color. The available colors are listed in https://billai.dev/api/references/theme-color.
		 */
	 ...
	 * and [ThemeIcon ids](https://billai.dev/api/references/icons-in-labels#icon-listing) are supported.
	...
	export class ThemeIcon {
		...
		/**
		 * The id of the icon. The available icons are listed in https://billai.dev/api/references/icons-in-labels#icon-listing.
		 */
		readonly id: string;
		 ...
		 * @param id id of the icon. The available icons are listed in https://billai.dev/api/references/icons-in-labels#icon-listing.
	...
	export class CodeActionKind {
		 ...
		 * normal [lightbulb](https://billai.dev/docs/editor/editingevolved#_code-action) menu. Source actions
	...
	export interface CodeActionContext {
		 ...
		 *
		 * Actions not of this kind are filtered out before being shown by the [lightbulb](https://billai.dev/docs/editor/editingevolved#_code-action).
		 */
	...
	export class CodeAction {
		 ...
		 *
		 * - Disabled code actions are not shown in automatic [lightbulb](https://billai.dev/docs/editor/editingevolved#_code-action)
		 * code action menu.
		 *
		 * - Disabled actions are shown as faded out in the code action menu when the user request a more specific type
		 * of code action, such as refactorings.
		 *
		 * - If the user has a [keybinding](https://billai.dev/docs/editor/refactoring#_keybindings-for-code-actions)
	 ...
	 *
	 * - The [lightbulb](https://billai.dev/docs/editor/editingevolved#_code-action) feature, which shows
	 ...
	 * the [symbol search](https://billai.dev/docs/editor/editingevolved#_open-symbol-by-name)-feature.
	 */
	 ...
	 * [the full snippet syntax](https://billai.dev/docs/editor/userdefinedsnippets#_create-your-own-snippets).
	 */
	 ...
	 * the [rename](https://billai.dev/docs/editor/editingevolved#_rename-symbol)-feature.
	 */
	 ...
	 * [IntelliSense](https://billai.dev/docs/editor/intellisense).
	 *
	 ...
	 * [Folding](https://billai.dev/docs/editor/codebasics#_folding) in the editor.
	 */
	 ...
	 * ```
	 *
	 * Refer to [Settings](https://billai.dev/docs/getstarted/settings) for more information.
	 */
	...
	export interface DiagnosticCollection extends Iterable<[uri: Uri, diagnostics: readonly Diagnostic[]]> {
		 ...
		 * name when defining [problem matchers](https://billai.dev/docs/editor/tasks#_defining-a-problem-matcher).
		 */
	...
	export interface LanguageStatusItem {
		 ...
		 *
		 * Where the icon-name is taken from the ThemeIcon [icon set](https://billai.dev/api/references/icons-in-labels#icon-listing), e.g.
	...
	export interface Terminal {
		...
		/**
		 * An object that contains [shell integration](https://billai.dev/docs/terminal/shell-integration)-powered
	...
	/**
	 * [Shell integration](https://billai.dev/docs/terminal/shell-integration)-powered capabilities owned by a terminal.
	 */
	export interface TerminalShellIntegration {
		 ...
		 * Execute a command, sending ^C as necessary to interrupt any running command if needed.
		 *
		 * *Note* This is not guaranteed to work as [shell integration](https://billai.dev/docs/terminal/shell-integration)
	...
	export namespace env {
		...
		/**
		 * The application name of the editor, like 'BillAI'.
		 */
	 ...
	 * the [command palette](https://billai.dev/docs/getstarted/userinterface#_command-palette).
	 * * keybinding - Use the `keybindings`-section in `package.json` to enable
	 * [keybindings](https://billai.dev/docs/getstarted/keybindings#_advanced-customization)
	 * for your extension.
	 *
	...
	export namespace window {
		 ...
		 * [shell integration](https://billai.dev/docs/terminal/shell-integration) is
	...
	export interface TerminalOptions {
		 ...
		 * via the [shell integration command decoration](https://billai.dev/docs/terminal/shell-integration#_command-decorations-and-the-overview-ruler).
		 *
		 * This should be used if the terminal includes [custom shell integration support](https://billai.dev/docs/terminal/shell-integration#_supported-escape-sequences).
	 ...
	 *
	 * Refer to https://billai.dev/docs/editor/workspaces for more information on
	...
	export namespace workspace {
		 ...
		 *
		 * Refer to https://billai.dev/docs/editor/workspaces for more information
		 * on workspaces.
		 *
		 ...
		 * workspace (see also: https://billai.dev/docs/editor/workspaces).
		 *
	...
	/**
	 * Namespace for participating in language-specific editor [features](https://billai.dev/docs/editor/editingevolved),
