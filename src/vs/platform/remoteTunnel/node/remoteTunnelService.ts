...
export class RemoteTunnelService extends Disposable implements IRemoteTunnelService {
	...
	private getTunnelCommandLocation() {
		if (!this._tunnelCommand) {
			...
			if (isMacintosh) {
				// appRoot = /Applications/BillAI - Insiders.app/Contents/Resources/app
				// bin = /Applications/BillAI - Insiders.app/Contents/Resources/app/bin
				...
				if (this.productService.quality === 'insider') {
					...
					// bin = C:\Users\<name>\AppData\Local\Programs\Microsoft BillAI Insiders\bin
