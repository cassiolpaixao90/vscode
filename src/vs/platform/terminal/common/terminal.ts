...
export interface IShellLaunchConfig {
	...
	/**
	 * Whether the terminal process environment will inherit BillAI's "shell environment" that may
	 ...
	 * a terminal used to drive some BillAI feature.
	 */
	isFeatureTerminal?: boolean;
	...
	tabActions?: ITerminalTabAction[];
	/**
	 * Report terminal's shell environment variables to BillAI and extensions
	 */
...
export const enum ShellIntegrationStatus {
	...
	FinalTerm,
	/** BillAI shell integration sequences have been encountered. Supercedes FinalTerm. */
	VSCode
}
